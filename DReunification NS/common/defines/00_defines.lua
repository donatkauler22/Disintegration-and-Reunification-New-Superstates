...
NGame = {
	...
	LAG_DAYS_FOR_PAUSE = 2500,						-- Days of client lag for pause of gamespeed.
	GAME_SPEED_SECONDS = { 2.0, 0.5, 0.2, 0.0, 0.0001 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "2025.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NCountry = {
	...
	POLITICAL_POWER_LOWER_CAP = -30000.0,				-- Min amount of political power country should have
	POLITICAL_POWER_UPPER_CAP = 30000.0,				-- Max amount of political power country should have
...
NProduction = {
	...
	CONVERSION_SPEED_BONUS = 1,							-- Modifier to the production speed when converting equipment
